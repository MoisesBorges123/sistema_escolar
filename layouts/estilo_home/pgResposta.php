...
*titulo
style
*tipo=1(#6be00e) / 2(#ffc107) / 3(#ff0707) / 4(#13c3f5)
*cabecalho
*cabecalho2
*descricao
link_back
...
<head>
        <meta charset="utf-8">
        <title><?php echo$titulo; date_default_timezone_set('America/Sao_paulo');?></title>
...
<body>
  <div id="wrapper">
    ...
    <!-- end header -->
    <section id="inner-headline" <?php echo"style='background-color:".$background."'"; ?> >
        <div class="container" >
        <div class="row">
          <div class="span9">
          ...
          <div class="span3">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo$link_back; ?>"><div class='btn btn-dark'>Voltar</div></a></li>
            </ul>
    ...
    <section id="content">
      <div class="container">
        <div class="row">
          <div class="span12">
            <h2 class="aligncenter"><?php echo$cabecalho2; ?></h3>
				<p class="aligncenter">
                                    <?php echo$descricao; ?>
				</p>
			</div>
